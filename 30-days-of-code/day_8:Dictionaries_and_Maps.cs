...
We then process each query and print key=value if the queried  is found in the map; otherwise,
we print Not found.
...
class Solution
{
    static void Main(String[] args)
    {
        ...
        string name_contact = Console.ReadLine();
        while (name_contact != null)
        {
            if (dict.ContainsKey(name_contact))
            {
                Console.WriteLine(name_contact + "=" + dict[name_contact]);
            }
            else
            {
